...
#include "strato/common/format.h"
#include "strato/common/signal.h"
#include "strato/common/utils.h"

extern "C" JNIEXPORT jobjectArray JNICALL Java_emu_strato_utils_GpuDriverHelper_00024Companion_getSystemDriverInfo(JNIEnv *env, jobject) {
...
extern "C" JNIEXPORT jboolean JNICALL Java_emu_strato_utils_GpuDriverHelper_00024Companion_supportsCustomDriverLoading(JNIEnv *env, jobject instance) {
    // If the KGSL device exists custom drivers can be loaded using adrenotools
    return CheckKgslPresent();
}

extern "C" JNIEXPORT jboolean JNICALL Java_emu_strato_utils_GpuDriverHelper_00024Companion_supportsForceMaxGpuClocks(JNIEnv *env, jobject instance) {
    // If the KGSL device exists adrenotools can be used to set GPU turbo mode
    return CheckKgslPresent();
}

extern "C" JNIEXPORT void JNICALL Java_emu_strato_utils_GpuDriverHelper_00024Companion_forceMaxGpuClocks(JNIEnv *env, jobject instance, jboolean enable) {
