...
namespace strato::service::timesrv {
    ...
    class TimeSpanType {
      ...
      public:
        ...
        static constexpr TimeSpanType FromSeconds(i64 s) {
            return {s * strato::constant::NsInSecond};
        }

        static constexpr TimeSpanType FromDays(i64 d) {
            return {d * strato::constant::NsInDay};
        }
        ...
        constexpr i64 Microseconds() const {
            return ns / strato::constant::NsInMicrosecond;
        }

        constexpr i64 Seconds() const {
            return ns / strato::constant::NsInSecond;
        }
