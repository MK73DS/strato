...
namespace strato::loader {
    /**
     * @brief The types of ROM files
     * @note This needs to be synchronized with emu.strato.loader.BaseLoader.RomFormat
     */
     ...
     * @note This needs to be synchronized with emu.strato.loader.LoaderResult
     */
