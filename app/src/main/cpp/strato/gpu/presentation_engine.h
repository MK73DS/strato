    ...
    class PresentationEngine {
      ...
      private:
        ...
        struct PresentableFrame {
            ...
            strato::service::hosbinder::AndroidFence fence{}; //!< The fence that must be waited on prior to using the texture
      ...
      public:
         ...
         * @param timestamp The earliest timestamp (relative to strato::util::GetTickNs) at which the frame must be presented, it should be 0 when it doesn't matter
