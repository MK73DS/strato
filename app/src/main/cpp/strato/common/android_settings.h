    ...
    class AndroidSettings final : public Settings {
      ...
      public:
        ...
        void Update() override {
            ...
            systemLanguage = ktSettings.GetInt<strato::language::SystemLanguage>("systemLanguage");
            systemRegion = ktSettings.GetInt<strato::region::RegionCode>("systemRegion");
            ...
            logLevel = ktSettings.GetInt<strato::AsyncLogger::LogLevel>("logLevel");
