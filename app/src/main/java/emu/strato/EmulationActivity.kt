...
import emu.strato.applet.swkbd.SoftwareKeyboardConfig
import emu.strato.applet.swkbd.SoftwareKeyboardDialog
import emu.strato.data.AppItem
import emu.strato.data.AppItemTag
import emu.strato.databinding.EmuActivityBinding
import emu.strato.emulation.PipelineLoadingFragment
import emu.strato.input.*
import emu.strato.loader.RomFile
import emu.strato.loader.getRomFormat
import emu.strato.settings.AppSettings
import emu.strato.settings.EmulationSettings
import emu.strato.settings.NativeSettings
import emu.strato.utils.ByteBufferSerializable
import emu.strato.utils.GpuDriverHelper
import emu.strato.utils.serializable
...
class EmulationActivity : AppCompatActivity(), SurfaceHolder.Callback, View.OnTouchListener, DisplayManager.DisplayListener {
    ...
    /**
     * This is the entry point into the emulation code for libstrato
     *
     ...
     * @param nativeSettings The settings to be used by libstrato
    ...
    /**
     * This sets the surface object in libstrato to the provided value, emulation is halted if set to null
     *
    ...
    override fun onDestroy() {
        ...
        // Stop forcing 60Hz on exit to allow the strato UI to run at high refresh rates
