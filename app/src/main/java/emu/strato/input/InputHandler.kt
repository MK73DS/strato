...
class InputHandler(private val inputManager : InputManager, private val emulationSettings : EmulationSettings) : SensorEventListener {
    companion object {
        /**
         * This initializes a guest controller in libstrato
         *
         ...
         * @param value A byte buffer of strato::input::MotionInput in C++
         */
         ...
         *
         * @param points An array of strato::input::TouchScreenPoint in C++ represented as integers
         */
    ...
    /**
     * Handles translating any [KeyHostEvent]s to a [GuestEvent] that is passed into libstrato
     */
    ...
    /**
     * Handles translating any [MotionHostEvent]s to a [GuestEvent] that is passed into libstrato
     */
    ...
    /**
     * This handles translating any [SensorEvent]s to a [GuestEvent] that is passed into libstrato
     */
    ...
    fun handleTouchEvent(view : View, event : MotionEvent) : Boolean {
        ...
        val points = IntArray(count * 7) // This is an array of strato::input::TouchScreenPoint in C++ as that allows for efficient transfer of values to it
        var offset = 0
